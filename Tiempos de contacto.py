...
for line in open('Eclipse19Nov.txt', 'r'):
...
#calculo del seno de "seno de psi":
...
#convertir tiempos en horas, minutos y segundos:
...
#pasar a min y seg
if (t3h==0):
    print('3er tiempo de contacto: 00 h',t3M,"m",t3s,"s\n")
else:
    print('3er tiempo de contacto:',t3h,"h",t3M,"m",t3s,"s\n")
